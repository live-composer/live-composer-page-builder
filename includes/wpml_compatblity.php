...
function dslc_convert_to_translation_array($post_id) {
	...
	$module_keys_array = [
		...
		'ACF_Taxonomy' => [],
		'ACF_User' => [],
		'LC_Before_After_Image' => [],
		'Breadcrumbs' => [],
		'LCPROEXT_Contact_Form_7' => [],
		'LCPROEXT_GravityForms' => [],
		'LCPROEXT_Ninja_Forms' => [],
		'LBMN_Ninja_Forms' => [],
		'LC_Gallery_Images_Grid_Module' => ['pagination_text'],
		'SKLC_GMaps_Module' => ['address'], // need to check if its required or not
		'DSLC_Menu_Pro' => [],
		'DSLC_Payment_Button' => ['button_text'],
		'LC_Prev_Next_Post_Links' => [],
		'LCPROEXT_MasterSlider' => [],
		'LCPROEXT_SliderRevolution' => [],
		'LC_Video_Embed_Module' => [],
    ];
