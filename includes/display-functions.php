...
function dslc_display_modules() {
	...
	if ( $dslc_modules ) {
		...
		foreach ( $dslc_modules as $dslc_module ) {
			...
			?>
				<div class="dslca-module dslca-scroller-item dslca-origin dslca-origin-<?php echo $dslc_module['origin'];
			}
			?>" data-origin="<?php echo $dslc_module['origin']; ?>" data-id="<?php echo $dslc_module['id']; ?>">
