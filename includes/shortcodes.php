...
function dslc_archive_heading_shortcode() {
	...
	elseif ( is_category() ) :
		$output .= __('Category Archives', 'live-composer-page-builder');
        $output .= sprintf( __( ': %s', 'live-composer-page-builder' ),'<span>' . single_cat_title( '', false ) . '</span>' );

	elseif ( is_tag() ) :
		$output .= __('Tag Archives','live-composer-page-builder');
		$output .= sprintf( __( ': %s', 'live-composer-page-builder' ), '<span>' . single_tag_title( '', false ) . '</span>' );
	...
	elseif ( is_author() ) :
		...
		*/
		the_post();
		$output .= __('Author Archives','live-composer-page-builder');
		$output .= sprintf( __( ': %s', 'live-composer-page-builder' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' );
	...
	elseif ( is_day() ) :
		$output .= __('Daily Archives','live-composer-page-builder');
		$output .= sprintf( __( ': %s', 'live-composer-page-builder' ), '<span>' . get_the_date() . '</span>' );

	elseif ( is_month() ) :
		$output .= __('Monthly Archives','live-composer-page-builder');
		$output .= sprintf( __( ': %s', 'live-composer-page-builder' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );

	elseif ( is_year() ) :
		$output .= __('Yearly Archives','live-composer-page-builder');
		$output .= sprintf( __( ': %s', 'live-composer-page-builder' ), '<span>' . get_the_date( 'Y' ) . '</span>' );
