...
<div class="wrap lc-wrap dslc-tab-extend lc-centered-panels">
	...
	<div class="dslc-panel lc-panel-intro padding-medium">
		...
		<h2 class="lc-huge"><?php _e( 'Unleash the power hidden in&nbsp;Live&nbsp;Composer', 'lbmn' ); ?></h2>
		<p class="lc-description lc-align-center"><?php _e( 'Combine Live&nbsp;Composer with our <strong>official premium theme</strong>. It&nbsp;comes bundled with premium plugins and design resources to&nbsp;get your WordPress development to a&nbsp;whole new level.', 'lbmn'); ?></p>
		...
		<div class="lc-premium-features">
			<a href="#woo" class="lc-premium-feature" tabindex="0" >
				...
				<p class="lc-premium-feature-description"><?php _e( 'WooCommerce Integration', 'lbmn' ); ?></p>
			</a>
			...
			<a href="#plugins" class="lc-premium-feature" tabindex="0" >
				...
				<p class="lc-premium-feature-description"><?php _e( 'Ten&nbsp;Additional Premium&nbsp;Modules', 'lbmn' ); ?></p>
			</a>
			...
			<a href="#acf" class="lc-premium-feature" tabindex="0" >
				...
				<p class="lc-premium-feature-description"><?php _e( 'Custom Post Types &amp; ACF Integration', 'lbmn' ); ?></p>
			</a>
			...
			<a href="#slider" class="lc-premium-feature" tabindex="0" >
				...
				<p class="lc-premium-feature-description"><?php _e( 'Premium Slider with Pro Animations ', 'lbmn' ); ?></p>
			</a>
			...
			<a href="#ranking" class="lc-premium-feature" tabindex="0" >
				...
				<p class="lc-premium-feature-description"><?php _e( 'Automated SEO Position Tracker', 'lbmn' ); ?></p>
			</a>
			...
			<a href="#menu" class="lc-premium-feature" tabindex="0" >
				...
				<p class="lc-premium-feature-description"><?php _e( 'Responsive Mega Menu Module', 'lbmn' ); ?></p>
			</a>
			...
			<a href="#ninja" class="lc-premium-feature" tabindex="0" >
				...
				<p class="lc-premium-feature-description"><?php _e( 'Ninja Forms Integration', 'lbmn' ); ?></p>
			</a>
			...
			<a href="#ninja" class="lc-premium-feature" tabindex="0" >
				...
				<p class="lc-premium-feature-description"><?php _e( 'MailChimp Extension for Ninja Forms', 'lbmn' ); ?></p>
			</a>
			...
			<a href="#ninja" class="lc-premium-feature" tabindex="0" >
				...
				<p class="lc-premium-feature-description"><?php _e( 'PayPal Payments for Ninja Forms', 'lbmn' ); ?></p>
			</a>
			...
			<a href="#designs" class="lc-premium-feature" tabindex="0" >
				...
				<p class="lc-premium-feature-description"><?php _e( '30+ Ready-To-Use Page Designs', 'lbmn' ); ?></p>
			</a>
			...
			<a href="#social" class="lc-premium-feature" tabindex="0" >
				...
				<p class="lc-premium-feature-description"><?php _e( 'Extensive Social Sharing Plugin', 'lbmn' ); ?></p>
			</a>
			...
			<a href="#support" class="lc-premium-feature" tabindex="0" >
				...
				<p class="lc-premium-feature-description"><?php _e( 'Same Day Premium Support', 'lbmn' ); ?></p>
			</a>
		</div>
	...
	<div class="dslc-panel lc-panel-cta lc-divided-panels padding-medium no-top-margin">
		<div class="lc-panel-half">
			<p class="lc-feature-description"><?php _e( 'This feature is part of our official premium theme package.' , 'lbmn'); ?></p>
		</div>
		<div class="lc-panel-half">
	...
	<div class="dslc-panel lc-divided-panels padding-medium">
		<div class="lc-panel-half">
			<h3 class="lc-huge margin-top-half"><?php _e( 'Additional Premium&nbsp;Modules', 'lbmn' ); ?></h3>
			<p class="lc-larger-text"><?php _e( 'Our official theme comes bundled with premium modules to extend design &amp; development possibilities.' , 'lbmn'); ?></p>
			<!-- <p><a href="#" class="button button-primary button-hero">Get Official Live Coposer Theme</a></p> -->
		</div>
	...
	<div class="dslc-panel lc-panel-acf lc-divided-panels padding-medium">
		<div class="lc-panel-half">
			<h3 class="lc-huge"><?php _e( 'Custom Post Types and Advanced Custom Fields Integration', 'lbmn' ); ?></h3>
			<p class="lc-larger-text"><?php _e( 'Collect PayPal payments or subscribe your visitors to MailChimp using any Ninja Form instance on your website.' , 'lbmn'); ?><br /><br /></p>
			<!-- <p><a href="#" class="button button-primary button-hero">Get Official Live Coposer Theme</a></p> -->
		</div>
		<div class="lc-panel-half lc-image-column">
			<img alt="<?php _e( 'Additional Premium&nbsp;Modules', 'lbmn' ); ?>" src="<?php echo DS_LIVE_COMPOSER_URL; ?>images/lc-acf.png">
		</div>
	...
	<div class="dslc-panel lc-divided-panels padding-medium">
		<div class="lc-panel-half">
			<h3 class="lc-huge"><?php _e( 'Premium&nbsp;Slider Included', 'lbmn' ); ?></h3>
			<p class="lc-larger-text"><?php _e( 'Combine Live Composer with a theme that was created form scratch speccially for Live Composer. ' , 'lbmn'); ?></p>
			<!-- <p><a href="#" class="button button-primary button-hero">Get Official Live Coposer Theme</a></p> -->
		</div>
		<div class="lc-panel-half lc-image-column">
			<img alt="<?php _e( 'Additional Premium&nbsp;Modules', 'lbmn' ); ?>" src="<?php echo DS_LIVE_COMPOSER_URL; ?>/images/lc-slider.png">
		</div>
	...
	<div class="dslc-panel lc-divided-panels lc-panel- padding-medium"
		...
		<div class="lc-text-center">
			...
			<h3 class="lc-huge"><?php _e( 'Professional SEO Tools Included', 'lbmn' ); ?></h3>
			<p class="lc-description"><?php _e( 'Get your game to a whole new level. Combine Live Composer with a theme that was created form scratch speccially for Live&nbsp;Composer. ' , 'lbmn'); ?></p>
		</div>
		<ul class="lc-column-list"  >
	...
	<div class="dslc-panel lc-divided-panels padding-medium">
		<div class="lc-panel-half">
			<h3 class="lc-huge"><?php _e( 'Responsive&nbsp;Mega Menu', 'lbmn' ); ?></h3>
			<p class="lc-larger-text"><?php _e( 'Combine Live Composer with a theme that was created form scratch speccially for Live Composer. ' , 'lbmn'); ?></p>
			<!-- <p><a href="#" class="button button-primary button-hero">Get Official Live Coposer Theme</a></p> -->
		</div>
		<div class="lc-panel-half lc-image-column">
			<img alt="<?php _e( 'Additional Premium&nbsp;Modules', 'lbmn' ); ?>" src="<?php echo DS_LIVE_COMPOSER_URL; ?>/images/lc-menu.png">
		</div>
	...
	<div class="dslc-panel lc-panel-ninjaforms lc-divided-panels padding-medium"
		...
		<div class="lc-panel-half">
			<h3 class="lc-huge"><?php _e( 'Advanced Ninja Form Integrations ', 'lbmn' ); ?></h3>
			<p class="lc-larger-text"><?php _e( 'Collect PayPal payments or subscribe your visitors to MailChimp using any Ninja Form instance on your website.' , 'lbmn'); ?><br /><br /></p>
		...
		<!-- <div class="lc-panel-half lc-image-column">
			<img alt="<?php _e( 'Additional Premium&nbsp;Modules', 'lbmn' ); ?>" src="<?php echo DS_LIVE_COMPOSER_URL; ?>images/lc-ninja.png">
		</div> -->
	</div>
	<div class="dslc-panel lc-panel-cta lc-divided-panels padding-medium no-top-margin lc-border-top">
		<div class="lc-panel-half">
	...
	<div class="dslc-panel lc-divided-panels lc-panel-designs lc-dark-panel padding-medium"
		...
		<div class="lc-text-center">
			...
			<h3 class="lc-huge"><?php _e( 'Premium Design Resources', 'lbmn' ); ?></h3>
			<p class="lc-description"><?php _e( 'Get your game to a whole new level. Combine Live Composer with a theme that was created form scratch speccially for Live&nbsp;Composer. ' , 'lbmn'); ?></p>
		</div>
		<ul class="lc-column-list"  >
			<li><span class="dashicons dashicons-yes"></span> 30 Professionally Designed Pages</li>
	...
	<div class="dslc-panel lc-panel-socialshare lc-divided-panels padding-medium"
		...
		<div class="lc-panel-half">
			<h3 class="lc-huge"><?php _e( 'Social Share Plugin', 'lbmn' ); ?></h3>
			<p class="lc-larger-text"><?php _e( 'Collect PayPal payments or subscribe your visitors to MailChimp using any Ninja Form instance on your website.' , 'lbmn'); ?><br /><br /></p>
	...
	<div class="dslc-panel lc-divided-panels padding-medium">
		<div class="lc-panel-half">
			<h3 class="lc-huge"><?php _e( 'Premium Same Day Support', 'lbmn' ); ?></h3>
			<p class="lc-larger-text"><?php _e( 'Get your game to a whole new level. Combine Live Composer with a theme that was created form scratch speccially for Live Composer. ' , 'lbmn'); ?></p>
		</div>
		<div class="lc-panel-half lc-image-column">
			<img alt="<?php _e( 'Additional Premium&nbsp;Modules', 'lbmn' ); ?>" src="<?php echo DS_LIVE_COMPOSER_URL; ?>/images/lc-support.png">
		</div>
	</div>
	<div class="dslc-panel lc-panel-cta lc-divided-panels padding-medium no-top-margin lc-border-top">
		<div class="lc-panel-half">
