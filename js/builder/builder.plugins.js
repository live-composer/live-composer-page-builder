...
!function(a){"use strict";"function"==typeof define&&define.amd?define(["jquery"],a):a($)}(function(a){"use strict";function B(a,b){this.el=a,this.options=b=T({},b),a[r]=this;var c={group:Math.random(),sort:!0,disabled:!1,store:null,handle:null,scroll:!0,scrollSensitivity:30,scrollSpeed:10,draggable:/[uo]l/i.test(a.nodeName)?"li":">*",ghostClass:"sortable-ghost",ignore:"a, img",filter:null,animation:0,setData:function(a,b){a.setData("Text",b.textContent)},dropBubble:!1,dragoverBubble:!1,dataIdAttr:"data-id",delay:0};for(var d in c)!(d in b)&&(b[d]=c[d]);var e=b.group;e&&"object"==typeof e||(e=b.group={name:e}),["pull","put"].forEach(function(a){a in e||(e[a]=!0)}),b.groups=" "+e.name+(e.put.join?" "+e.put.join(" "):"")+" ";for(var f in this)"_"===f.charAt(0)&&(this[f]=D(this,this[f]));G(a,"touchstart",this._onTapStart),window.navigator.msPointerEnabled?G(a,"pointerdown",this._onTapStart):G(a,"mousedown",this._onTapStart),G(a,"dragover",this),G(a,"dragenter",this),z.push(this._onDragOver),b.store&&this.sort(b.store.get(this))}function C(a){d&&d.state!==a&&(J(d,"display",a?"none":""),!a&&d.state&&e.insertBefore(d,b),d.state=a)}function D(a,b){var c=y.call(arguments,2);return b.bind?b.bind.apply(b,[a].concat(c)):function(){return b.apply(a,c.concat(y.call(arguments)))}}function E(a,b,c){if(a){c=c||t,b=b.split(".");var d=b.shift().toUpperCase(),e=new RegExp("\\s("+b.join("|")+")(?=\\s)","g");do if(">*"===d&&a.parentNode===c||(""===d||a.nodeName.toUpperCase()==d)&&(!b.length||((" "+a.className+" ").match(e)||[]).length==b.length))return a;while(a!==c&&(a=a.parentNode))}return null}function F(a){a.dataTransfer.dropEffect="move",a.preventDefault()}function G(a,b,c){a.addEventListener(b,c,!1)}function H(a,b,c){a.removeEventListener(b,c,!1)}function I(a,b,c){if(a)if(a.classList)a.classList[c?"add":"remove"](b);else{var d=(" "+a.className+" ").replace(q," ").replace(" "+b+" "," ");a.className=(d+(c?" "+b:"")).replace(q," ")}}function J(a,b,c){var d=a&&a.style;if(d){if(void 0===c)return t.defaultView&&t.defaultView.getComputedStyle?c=t.defaultView.getComputedStyle(a,""):a.currentStyle&&(c=a.currentStyle),void 0===b?c:c[b];b in d||(b="-webkit-"+b),d[b]=c+("string"==typeof c?"":"px")}}function K(a,b,c){if(a){var d=a.getElementsByTagName(b),e=0,f=d.length;if(c)for(;e<f;e++)c(d[e],e);return d}return[]}function L(a,b,c,e,f,g,h){var i=t.createEvent("Event"),j=(a||b[r]).options,k="on"+c.charAt(0).toUpperCase()+c.substr(1);i.initEvent(c,!0,!0),i.to=b,i.from=f||b,i.item=e||b,i.clone=d,i.oldIndex=g,i.newIndex=h,b.dispatchEvent(i),j[k]&&j[k].call(a,i)}function M(a,b,c,d,e,f){var g,j,h=a[r],i=h.options.onMove;return i&&(g=t.createEvent("Event"),g.initEvent("move",!0,!0),g.to=b,g.from=a,g.dragged=c,g.draggedRect=d,g.related=e||b,g.relatedRect=f||b.getBoundingClientRect(),j=i.call(h,g)),j}function N(a){a.draggable=!1}function O(){w=!1}function P(a,b){var c=a.lastElementChild,d=c.getBoundingClientRect();return b.clientY-(d.top+d.height)>5&&c}function Q(a){for(var b=a.tagName+a.className+a.src+a.href+a.textContent,c=b.length,d=0;c--;)d+=b.charCodeAt(c);return d.toString(36)}function R(a){for(var b=0;a&&(a=a.previousElementSibling);)"TEMPLATE"!==a.nodeName.toUpperCase()&&b++;return b}function S(a,b){var c,d;return function(){void 0===c&&(c=arguments,d=this,setTimeout(function(){1===c.length?a.call(d,c[0]):a.apply(d,c),c=void 0},b))}}function T(a,b){if(a&&b)for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c]);return a}var b,c,d,e,f,g,h,i,j,k,l,m,o,p,n={},q=/\s+/g,r="Sortable"+(new Date).getTime(),s=window,t=s.document,u=s.parseInt,v=!!("draggable"in t.createElement("div")),w=!1,x=Math.abs,y=[].slice,z=[],A=S(function(a,b,c){if(c&&b.scroll){var d,e,o,p,f=b.scrollSensitivity,i=b.scrollSpeed,j=a.clientX,k=a.clientY,l=window.innerWidth,m=window.innerHeight;if(h!==c&&(g=b.scroll,h=c,g===!0)){g=c;do if(g.offsetWidth<g.scrollWidth||g.offsetHeight<g.scrollHeight)break;while(g=g.parentNode)}g&&(d=g,e=g.getBoundingClientRect(),o=(x(e.right-j)<=f)-(x(e.left-j)<=f),p=(x(e.bottom-k)<=f)-(x(e.top-k)<=f)),o||p||(o=(l-j<=f)-(j<=f),p=(m-k<=f)-(k<=f),(o||p)&&(d=s)),n.vx===o&&n.vy===p&&n.el===d||(n.el=d,n.vx=o,n.vy=p,clearInterval(n.pid),d&&(n.pid=setInterval(function(){d===s?s.scrollTo(s.pageXOffset+o*i,s.pageYOffset+p*i):(p&&(d.scrollTop+=p*i),o&&(d.scrollLeft+=o*i))},24)))}},30);B.prototype={constructor:B,_onTapStart:function(a){var b=this,c=this.el,d=this.options,e=a.type,f=a.touches&&a.touches[0],g=(f||a).target,h=g,i=d.filter;if("touch"==a.pointerType&&(f=a),!("mousedown"===e&&0!==a.button||d.disabled)&&(g=E(g,d.draggable,c))){if(k=R(g),"function"==typeof i){if(i.call(this,a,g,this))return L(b,h,"filter",g,c,k),void a.preventDefault()}else if(i&&(i=i.split(",").some(function(a){if(a=E(h,a.trim(),c))return L(b,a,"filter",g,c,k),!0})))return void a.preventDefault();d.handle&&!E(h,d.handle,c)||this._prepareDragStart(a,f,g)}},_prepareDragStart:function(a,c,d){var k,g=this,h=g.el,i=g.options,j=h.ownerDocument;d&&!b&&d.parentNode===h&&(o=a,e=h,b=d,f=b.nextSibling,m=i.group,k=function(){g._disableDelayedDrag(),b.draggable=!0,i.ignore.split(",").forEach(function(a){K(b,a.trim(),N)}),g._triggerDragStart(c)},G(j,"mouseup",g._onDrop),G(j,"touchend",g._onDrop),G(j,"touchcancel",g._onDrop),i.delay?(G(j,"mousemove",g._disableDelayedDrag),G(j,"touchmove",g._disableDelayedDrag),g._dragStartTimer=setTimeout(k,i.delay)):k())},_disableDelayedDrag:function(){var a=this.el.ownerDocument;clearTimeout(this._dragStartTimer),H(a,"mousemove",this._disableDelayedDrag),H(a,"touchmove",this._disableDelayedDrag)},_triggerDragStart:function(a){a?(o={target:b,clientX:a.clientX,clientY:a.clientY},this._onDragStart(o,"touch")):v?(G(b,"dragend",this),G(e,"dragstart",this._onDragStart)):this._onDragStart(o,!0);try{t.selection?t.selection.empty():window.getSelection().removeAllRanges()}catch(a){}},_dragStarted:function(){e&&b&&(I(b,this.options.ghostClass,!0),B.active=this,L(this,e,"start",b,e,k))},_emulateDragOver:function(){if(p){J(c,"display","none");var a=t.elementFromPoint(p.clientX,p.clientY),b=a,d=" "+this.options.group.name,e=z.length;if(b)do{if(b[r]&&b[r].options.groups.indexOf(d)>-1){for(;e--;)z[e]({clientX:p.clientX,clientY:p.clientY,target:a,rootEl:b});break}a=b}while(b=b.parentNode);J(c,"display","")}},_onTouchMove:function(a){if(o){var b=a.touches?a.touches[0]:a,d=b.clientX-o.clientX,e=b.clientY-o.clientY,f=a.touches?"translate3d("+d+"px,"+e+"px,0)":"translate("+d+"px,"+e+"px)";p=b,J(c,"webkitTransform",f),J(c,"mozTransform",f),J(c,"msTransform",f),J(c,"transform",f),a.preventDefault()}},_onDragStart:function(a,f){var g=a.dataTransfer,h=this.options;if(this._offUpEvents(),"clone"==m.pull&&(d=b.cloneNode(!0),J(d,"display","none"),e.insertBefore(d,b)),f){var k,i=b.getBoundingClientRect(),j=J(b);c=b.cloneNode(!0),J(c,"top",i.top-u(j.marginTop,10)),J(c,"left",i.left-u(j.marginLeft,10)),J(c,"width",i.width),J(c,"height",i.height),J(c,"opacity","0.8"),J(c,"position","fixed"),J(c,"zIndex","100000"),e.appendChild(c),k=c.getBoundingClientRect(),J(c,"width",2*i.width-k.width),J(c,"height",2*i.height-k.height),"touch"===f?(G(t,"touchmove",this._onTouchMove),G(t,"touchend",this._onDrop),G(t,"touchcancel",this._onDrop),G(t,"pointermove",this._onTouchMove),G(t,"pointerup",this._onDrop),G(t,"pointercancel",this._onDrop)):(G(t,"mousemove",this._onTouchMove),G(t,"mouseup",this._onDrop)),this._loopId=setInterval(this._emulateDragOver,150)}else g&&(g.effectAllowed="move",h.setData&&h.setData.call(this,g,b)),G(t,"drop",this);setTimeout(this._dragStarted,0)},_onDragOver:function(a){var h,k,l,g=this.el,n=this.options,o=n.group,p=o.put,q=m===o,s=n.sort;if(void 0!==a.preventDefault&&(a.preventDefault(),!n.dragoverBubble&&a.stopPropagation()),m&&!n.disabled&&(q?s||(l=!e.contains(b)):m.pull&&p&&(m.name===o.name||p.indexOf&&~p.indexOf(m.name)))&&(void 0===a.rootEl||a.rootEl===this.el)){if(A(a,n,this.el),w)return;if(h=E(a.target,n.draggable,g),k=b.getBoundingClientRect(),l)return C(!0),void(d||f?e.insertBefore(b,d||f):s||e.appendChild(b));if(0===g.children.length||g.children[0]===c||g===a.target&&(h=P(g,a))){if(h){if(h.animated)return;t=h.getBoundingClientRect()}C(q),M(e,g,b,k,h,t)!==!1&&(g.appendChild(b),this._animate(k,b),h&&this._animate(t,h))}else if(h&&!h.animated&&h!==b&&void 0!==h.parentNode[r]){i!==h&&(i=h,j=J(h));var G,t=h.getBoundingClientRect(),u=t.right-t.left,v=t.bottom-t.top,x=/left|right|inline/.test(j.cssFloat+j.display),y=h.offsetWidth>b.offsetWidth,z=h.offsetHeight>b.offsetHeight,B=(x?(a.clientX-t.left)/u:(a.clientY-t.top)/v)>.5,D=h.nextElementSibling,F=M(e,g,b,k,h,t);F!==!1&&(w=!0,setTimeout(O,30),C(q),G=1===F||F===-1?1===F:x?h.previousElementSibling===b&&!y||B&&y:D!==b&&!z||B&&z,G&&!D?g.appendChild(b):h.parentNode.insertBefore(b,G?D:h),this._animate(k,b),this._animate(t,h))}}},_animate:function(a,b){var c=this.options.animation;if(c){var d=b.getBoundingClientRect();J(b,"transition","none"),J(b,"transform","translate3d("+(a.left-d.left)+"px,"+(a.top-d.top)+"px,0)"),b.offsetWidth,J(b,"transition","all "+c+"ms"),J(b,"transform","translate3d(0,0,0)"),clearTimeout(b.animated),b.animated=setTimeout(function(){J(b,"transition",""),J(b,"transform",""),b.animated=!1},c)}},_offUpEvents:function(){var a=this.el.ownerDocument;H(t,"touchmove",this._onTouchMove),H(a,"mouseup",this._onDrop),H(a,"touchend",this._onDrop),H(a,"touchcancel",this._onDrop),H(t,"pointermove",this._onTouchMove),H(a,"pointerup",this._onDrop),H(a,"pointercancel",this._onDrop)},_onDrop:function(a){var q=this.el,r=this.options;clearInterval(this._loopId),clearInterval(n.pid),clearTimeout(this._dragStartTimer),H(t,"drop",this),H(t,"mousemove",this._onTouchMove),H(q,"dragstart",this._onDragStart),this._offUpEvents(),a&&(a.preventDefault(),!r.dropBubble&&a.stopPropagation(),c&&c.parentNode.removeChild(c),b&&(H(b,"dragend",this),N(b),I(b,this.options.ghostClass,!1),e!==b.parentNode?(l=R(b),L(null,b.parentNode,"sort",b,e,k,l),L(this,e,"sort",b,e,k,l),L(null,b.parentNode,"add",b,e,k,l),L(this,e,"remove",b,e,k,l)):(d&&d.parentNode.removeChild(d),b.nextSibling!==f&&(l=R(b),L(this,e,"update",b,e,k,l),L(this,e,"sort",b,e,k,l))),B.active&&(L(this,e,"end",b,e,k,l),this.save())),e=b=c=f=d=g=h=o=p=i=j=m=B.active=null)},handleEvent:function(a){var c=a.type;"dragover"===c||"dragenter"===c?b&&(this._onDragOver(a),F(a)):"drop"!==c&&"dragend"!==c||this._onDrop(a)},toArray:function(){for(var b,a=[],c=this.el.children,d=0,e=c.length,f=this.options;d<e;d++)b=c[d],E(b,f.draggable,this.el)&&a.push(b.getAttribute(f.dataIdAttr)||Q(b));return a},sort:function(a){var b={},c=this.el;this.toArray().forEach(function(a,d){var e=c.children[d];E(e,this.options.draggable,c)&&(b[a]=e)},this),a.forEach(function(a){b[a]&&(c.removeChild(b[a]),c.appendChild(b[a]))})},save:function(){var a=this.options.store;a&&a.set(this)},closest:function(a,b){return E(a,b||this.options.draggable,this.el)},option:function(a,b){var c=this.options;return void 0===b?c[a]:void(c[a]=b)},destroy:function(){var a=this.el;a[r]=null,window.navigator.msPointerEnabled?H(a,"pointerdown",this._onTapStart):H(a,"mousedown",this._onTapStart),H(a,"touchstart",this._onTapStart),H(a,"dragover",this),H(a,"dragenter",this),Array.prototype.forEach.call(a.querySelectorAll("[draggable]"),function(a){a.removeAttribute("draggable")}),z.splice(z.indexOf(this._onDragOver),1),this._onDrop(),this.el=a=null}},B.utils={on:G,off:H,css:J,find:K,bind:D,is:function(a,b){return!!E(a,b,a)},extend:T,throttle:S,closest:E,toggleClass:I,index:R},B.version="1.2.1",B.create=function(a,b){return new B(a,b)},jQuery.fn.sortable_vanilla=function(a){var b;return this.each(function(){var c=jQuery(this),d=c.data("sortable");if(d||!(a instanceof Object)&&a||(d=new B(this,a),c.data("sortable",d)),d){if("widget"===a)return d;"destroy"===a?(d.destroy(),c.removeData("sortable")):a in d&&(b=d[d].apply(d,[].slice.call(arguments,1)))}}),void 0===b?this:b}});
