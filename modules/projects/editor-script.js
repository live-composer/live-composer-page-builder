...
;(function(){
	...
	jQuery(document).on('DSLC_extend_modules', function(){
		...
		var Projects = DSLC.ModulesManager.AvailModules.DSLC_Projects;

		Projects.prototype.changeOptionsBeforeRender = function(options)
		{
			var opt = options;
			/**
			* Common
			...
			*/
			...
			// Posts container
			opt.container_class = 'dslc-posts dslc-projects dslc-clearfix dslc-posts-orientation-'
			 + opt.orientation.value + ' ';
			...
			// Post
			opt.element_class = 'dslc-post dslc-project ';
