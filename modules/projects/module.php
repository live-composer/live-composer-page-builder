...
class DSLC_Projects extends DSLC_Module {
	...
	function options() {
		...
		$dslc_options = array(
			...
			array(
				'id' => 'css_thumbnail_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_thumbnail_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_thumbnail_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_thumbnail_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_thumbnail_padding_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_thumbnail_padding_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_thumbnail_padding_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_thumbnail_padding_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_main_inner_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_main_inner_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_main_inner_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_main_inner_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_cats_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_staff_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_staff_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_partner_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_partner_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_partner_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_partner_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_excerpt_padding_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_excerpt_padding_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_excerpt_padding_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_excerpt_padding_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_thumbnail_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_thumbnail_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_thumbnail_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_thumbnail_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_thumbnail_padding_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_thumbnail_padding_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_thumbnail_padding_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_thumbnail_padding_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_cats_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_cats_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_cats_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_cats_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_staff_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_staff_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_staff_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_staff_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_partner_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_partner_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_partner_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_partner_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_thumbnail_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_thumbnail_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_thumbnail_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_thumbnail_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_thumbnail_padding_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_thumbnail_padding_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_thumbnail_padding_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_thumbnail_padding_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_cats_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_cats_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_cats_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_cats_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_staff_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_staff_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_staff_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_staff_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_partner_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_partner_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_partner_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_partner_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
