...
class DSLC_Related_Posts extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'DSLC_Related_Posts';
		$this->module_title = __( 'Related Posts', 'live-composer-page-builder' );
	...
	?>
		[dslc_module_related_post_output]<?php echo serialize( $dslc_options ); ?>[/dslc_module_related_post_output]
	<?php
	}
}

function dslc_module_related_post_output( $atts, $content = null ) {
		...
		<div class="dslc-module-heading">
			...
			<?php if ( $show_heading ) : ?>
                ...
                <div class="dslc-post-heading">
                    ...
                    <h2 class="dslca-editable-content" data-id="main_heading_title" data-type="simple" <?php if ( $dslc_is_admin ) { echo 'contenteditable';} ?> >
                        <?php echo stripslashes( $options['main_heading_title'] ); ?>
                    </h2>
                    ...
                    <?php if ( isset( $options['view_all_link'] ) && $options['view_all_link'] !== '' ) : ?>
                        ...
                        <span class="dslc-module-heading-view-all">
                            <a href="<?php echo $options['view_all_link']; ?>" class="dslca-editable-content" data-id="main_heading_link_title" data-type="simple" <?php if ( $dslc_is_admin ) { echo 'contenteditable';} ?> >
                                <?php echo $options['main_heading_link_title']; ?>
                            </a>
                        </span>
			...
			if ( $show_filters ) {
				...
				<div class="dslc-post-filters">
                    <span class="dslc-post-filter dslc-active dslca-editable-content" data-filter-id="show-all" <?php if ( $dslc_is_admin ) { echo 'data-id="main_filter_title_all" data-type="simple" contenteditable '; } ?>>
                        <?php echo $options['main_filter_title_all']; ?>
                    </span>

					<?php foreach ( $cats_array as $cat_slug => $cat_name ) : ?>
                        <span class="dslc-post-filter dslc-inactive" data-filter-id="<?php echo $cat_slug; ?>">
                            <?php echo $cat_name; ?>
                        </span>
                    <?php endforeach; ?>
	...
	} else { echo 'false'; } ?>" data-slide-speed="<?php echo $options['arrows_slide_speed']; ?>" data-pagination-speed="<?php echo $options['circles_slide_speed']; ?>"><?php
...
} add_shortcode( 'dslc_module_related_post_output', 'dslc_module_related_post_output' );
