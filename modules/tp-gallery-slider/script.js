...
;(function(){
	...
	DSLCProd.Modules.gallerySlider = {};
	DSLCProd.Modules.gallerySlider.initCarousel = function()
	{
		// Loop through each carousel
		jQuery('.dslc-slider.gallery-slider').each(function(){
