...
class DSLC_Text_Simple extends DSLC_Module {
	...
	function options() {
		...
		$dslc_options = array(
			...
			array(
				'id' => 'css_res_t_blockquote_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_blockquote_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_blockquote_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_blockquote_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'label' => __( 'Padding ( paragraph )', 'live-composer-page-builder' ),
				'id' => 'css_res_ph_main_p_padding_group',
				'type' => 'group',
				'action' => 'open',
				'section' => 'responsive',
				'tab' => __( 'Phone', 'live-composer-page-builder' ),
			...
			array(
				'id' => 'css_res_ph_main_p_padding_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'label' => __( 'Top', 'live-composer-page-builder' ),
				'id' => 'css_res_ph_main_p_padding_top',
				'std' => '0',
				'min' => -2000,
				'max' => 2000,
				'type' => 'slider',
			...
			array(
				'id' => 'css_res_ph_main_p_padding_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'label' => __( 'Right', 'live-composer-page-builder' ),
				'id' => 'css_res_ph_main_p_padding_right',
				'std' => '0',
				'min' => -2000,
				'max' => 2000,
				'type' => 'slider',
			...
			array(
				'id' => 'css_res_ph_main_p_padding_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'label' => __( 'Bottom', 'live-composer-page-builder' ),
				'id' => 'css_res_ph_main_p_padding_bottom',
				'std' => '0',
				'min' => -2000,
				'max' => 2000,
				'type' => 'slider',
			...
			array(
				'id' => 'css_res_ph_main_p_padding_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'label' => __( 'Left', 'live-composer-page-builder' ),
				'id' => 'css_res_ph_main_p_padding_left',
				'std' => '0',
				'min' => -2000,
				'max' => 2000,
				'type' => 'slider',
			...
			array(
				'id' => 'css_res_ph_h1_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_ph_h1_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_ph_h1_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_ph_h1_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_blockquote_padding_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_blockquote_padding_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_blockquote_padding_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_blockquote_padding_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_blockquote_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_blockquote_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_blockquote_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_blockquote_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
