...
;(function(){
	...
	jQuery(document).on('click', '.dslc-post-filter.dslc-staff-module', function($){
	...
	{
		DSLCProd.Modules.staffSlider.initCarousel();
	});

	DSLCProd.Modules.staffSlider = {};
	DSLCProd.Modules.staffSlider.initCarousel = function()
	{
