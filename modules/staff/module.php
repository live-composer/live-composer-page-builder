...
class DSLC_Staff extends DSLC_Module {
	...
	function options() {
		...
		$dslc_options = array(
			...
			array(
				'id' => 'css_position_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_position_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_position_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_position_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_position_padding_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_position_padding_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_position_padding_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_position_padding_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_social_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_social_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_social_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_social_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_social_padding_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_social_padding_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_social_padding_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_social_padding_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_position_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_position_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_position_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_t_position_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				...
				array(
					'id' => 'css_res_t_position_padding_top_unit',
					'std' => 'px',
					'label' => __( 'Top Unit', 'live-composer-page-builder' ),
					'type' => 'select',
					'refresh_on_change' => false,
				...
				array(
					'id' => 'css_res_t_position_padding_bottom_unit',
					'std' => 'px',
					'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
					'type' => 'select',
					'refresh_on_change' => false,
				...
				array(
					'id' => 'css_res_t_position_padding_left_unit',
					'std' => 'px',
					'label' => __( 'Left Unit', 'live-composer-page-builder' ),
					'type' => 'select',
					'refresh_on_change' => false,
				...
				array(
					'id' => 'css_res_t_position_padding_right_unit',
					'std' => 'px',
					'label' => __( 'Right Unit', 'live-composer-page-builder' ),
					'type' => 'select',
					'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_social_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_social_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_social_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_social_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_social_padding_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_social_padding_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_social_padding_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_social_padding_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_position_margin_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_position_margin_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_position_margin_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_position_margin_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_position_padding_top_unit',
				'std' => 'px',
				'label' => __( 'Top Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_position_padding_bottom_unit',
				'std' => 'px',
				'label' => __( 'Bottom Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_position_padding_left_unit',
				'std' => 'px',
				'label' => __( 'Left Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
			...
			array(
				'id' => 'css_res_p_position_padding_right_unit',
				'std' => 'px',
				'label' => __( 'Right Unit', 'live-composer-page-builder' ),
				'type' => 'select',
				'refresh_on_change' => false,
