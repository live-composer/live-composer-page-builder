...
;(function(){
	...
	jQuery(document).on('DSLC_extend_modules', function(){
		...
		var Galleries = DSLC.ModulesManager.AvailModules.DSLC_Galleries;

		Galleries.prototype.changeOptionsBeforeRender = function(options)
		{
			var opt = options;
			/**
			* Common
		...
		Galleries.prototype.afterRenderHook = function()
		{
			DSLCProd.Modules.galleriesSlider.initCarousel();
		}
	});
}());