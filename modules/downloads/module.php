...
?></h2>
	...
	: ?>
				...
				if ( $dslc_is_admin ) :
					?><div class="dslc-notification dslc-red"><?php _e( 'You do not have downloads at the moment. Go to <strong>WP Admin &rarr; Downloads</strong> to add some.', 'live-composer-page-builder' );
			}
