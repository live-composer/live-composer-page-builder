...
;(function(){
	...
	jQuery(document).on('click', '.dslc-post-filter.dslc-downloads-module', function($){
	...
	{
		DSLCProd.Modules.downloadsSlider.initCarousel();
	});

	DSLCProd.Modules.downloadsSlider = {};
	DSLCProd.Modules.downloadsSlider.initCarousel = function()
	{
