...
?>
											...
											<?php if ( ( $options['main_location'] == 'inside' || $options['main_location'] == 'inside_visible' ) && ( $post_elements == 'all' || in_array( 'title', $post_elements ) || in_array( 'excerpt', $post_elements ) ) ) : ?>
												...
												<div class="dslc-post-main dslc-partner-main <?php if ( $options['main_location'] == 'inside_visible' ) {
	echo 'dslc-partner-main-visible';
}
...
?></h2>
	...
	:
				...
				if ( $dslc_is_admin ) :
					?><div class="dslc-notification dslc-red"><?php _e( 'You do not have any partners at the moment. Go to <strong>WP Admin &rarr; Partners</strong> to add some.', 'live-composer-page-builder' );
}
