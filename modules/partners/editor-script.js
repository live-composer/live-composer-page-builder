...
;(function(){
	...
	jQuery(document).on('DSLC_extend_modules', function(){
		...
		var Partners = DSLC.ModulesManager.AvailModules.DSLC_Partners;

		Partners.prototype.changeOptionsBeforeRender = function(options)
		{
			var opt = options;
			/**
			* Common
			...
			*/
			...
			// Posts container
			opt.container_class = 'dslc-posts dslc-partners dslc-clearfix dslc-posts-orientation-' + opt.orientation.value + ' ';
			...
			// Post
			opt.element_class = 'dslc-post dslc-partner ';
		...
		Partners.prototype.afterRenderHook = function()
		{
			DSLCProd.Modules.partnersSlider.initCarousel();
		}
	});
}());