...
;(function(){
	...
	jQuery(document).on('click', '.dslc-post-filter.dslc-partners-module', function($){
	...
	DSLCProd.Modules.partnersSlider = {};
	DSLCProd.Modules.partnersSlider.initCarousel = function()
	{
