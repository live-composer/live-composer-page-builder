...
class DSLC_Blog extends DSLC_Module {
	...
	function render_blog_posts( $atts, $content ) {
		...
		if ( $dslc_query->have_posts() ) {
			...
			while ( $dslc_query->have_posts() ) {
				...
				$LC_Registry->set( 'dslc-blog-share-info', $share_info );
				$LC_Registry->set( 'dslc-blog-posts-elem-index', $cnt );
	 ...
	 * @return string
	 */
	function blog_author_posts_link() {
	...
	/**
	 * Returns facebook social for each post
	 * @return string
	 */
	function share_info_fb() {
		...
		<a href="#" class="lc-editor-element" target="_blank" onClick="return dslc_social_share(400, 300, 'http://www.facebook.com/share.php?u=<?php echo get_permalink( get_the_ID() ); ?>')">
			...
			<span class="dslc-posts-social-share-count" data-module-method="share_info_fb">
	...
	function share_info_pt() {
		...
		?>
		<a href="#" class="lc-editor-element" onClick="return dslc_social_share(400, 300, 'https://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&amp;media=<?php echo esc_html( $post_img ); ?>&amp;description=<?php echo esc_attr( get_the_excerpt() ); ?>')">
			<span class="dslc-icon dslc-icon-pinterest"></span>
	...
	function share_info_tw() {
		...
		?>
		<a href="#" class="lc-editor-element" onClick="return dslc_social_share(400, 300, 'https://twitter.com/home?status=<?php echo $share_status; ?>')" >
	 ...
	 * @return string
	 */
	function blog_pagination_nav( $atts ) {
