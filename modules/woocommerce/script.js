/**
 * WooCommerce production scripts
 */
...
;(function(){
	...
	jQuery(document).on('click', '.dslc-post-filter.dslca-wooc-module', function($){
	...
	DSLCProd.Modules.woocommerceSlider = {};
	DSLCProd.Modules.woocommerceSlider.initCarousel = function()
	{
